...
def main():
    ...
    with home_holder:
        ...
        with st.form("my_form"):
            ...
            st.info('לאבחנה נדרשת נוכחות של 9 מהסתסמינים הבאים, מכלל חמשל האשוכולות הבאים, ובתנאי שהתסמינים החלו להופיע או להחמיר לאחר האירוע שדווח בקריטריון A')
            st.write('**חודרנות**')
            ...
            cat_d = st.radio('קיימת פגיעה תפקודימת במישורים משפחתיים / חברתיים / תעסוקתיים / אחר', ["לא", "כן"])
            st.divider()
